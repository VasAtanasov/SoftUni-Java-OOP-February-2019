...
public class Test25 {
    ...
    public void GetByTransactionStatus_ShouldReturnCorrectResult()
    {
        ...
        Transaction tx4 = new TransactionImpl(3, TransactionStatus.Failed, "valq", "pesho", 15.6);
        Transaction tx5 = new TransactionImpl(8, TransactionStatus.Successfull, "valq", "pesho", 17.8);
